...
class BukkitCoroutineDispatchers internal constructor(val plugin: Plugin) {

    @OptIn(InternalCoroutinesApi::class)
    inner class SyncDispatcher internal constructor(): CoroutineDispatcher(), Delay {
    ...
    @OptIn(InternalCoroutinesApi::class)
    inner class AsyncDispatcher internal constructor(): CoroutineDispatcher(), Delay {
